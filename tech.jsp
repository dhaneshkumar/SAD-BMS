<%@include
	file="common.jsp" %>
                ...
                <li class="active"><a href="tech.jsp">Technical</a></li>
	...
	<br><br>
     ...
     <div> 
	  ...
	  <tr >
			...
			<td><h3 align="center">  Upcoming Technical Events</h3>
			</td>
				...
				<div class="accordion-group">
					<div class="accordion-heading">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
							Search Upcoming Technical Events by name
						</a>
					</div>
			  ...
			  <div class="accordion-group">
				<div class="accordion-heading">
				  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
					View results of Technical Events
				  </a>
				</div>
			  ...
			  <div class="accordion-group">
				<div class="accordion-heading">
				  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">
					Search Upcoming Technical Events by Genre 
				  </a>
				</div>
			  ...
			  <div class="accordion-group">
				<div class="accordion-heading">
				  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#tally">
					Current Hostel Standing in Technical Events
				  </a>
				</div>
			  </div>
